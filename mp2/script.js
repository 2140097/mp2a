...
function startRequest(){
    ...
    classesRequest.open('GET', 'http://192.168.1.2/class1.json');
    classesRequest.onload = function(){
        ...
        localStorage.setItem("classesBackup", classesResponseText);
    };
    classesRequest.send();
...
function showStudents(){
    ...
    varRow.setAttribute("id", "headers");
                    ...
                    for(z=0; z<classes[x].classdays[y].classhours.length; z++){
                        if(selectedClasshour == classes[x].classdays[y].classhours[z].classhour){
                            ...
                            for(a=0; a<classes[x].classdays[y].classhours[z].students.length; a++){
                                ...
                                varReportTdText = document.createTextNode("");
                            ...
                            if(lateDetails[4] == classes[x].classdays[y].classhours[z].classhour){
                                for(a=0; a<classes[x].classdays[y].classhours[z].students.length; a++){
                                    if(lateDetails[1] == classes[x].classdays[y].classhours[z].students[a].idno){
                                        ...
                                        classes[x].classdays[y].classhours[z].students[a].report += "-" + lateDetails[5] + " points: "+reported;
                                        console.log(classes[x].classdays[y].classhours[z].students[a].name +" demerit:"+classes[x].classdays[y].classhours[z].students[a].demerit + classes[x].classdays[y].classhours[z].students[a].report);
...
function showReport(){
    ...
    localStorage.setItem("report", todaysReports);
    var reportWindow = window.open("reports.html", '_blank');
    reportWindow.focus();
}

function resetLocalStorage(){
    backupClass = localStorage.getItem("classesBackup");
    localStorage.setItem("classes", backupClass);
}
